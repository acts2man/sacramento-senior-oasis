/**
 * Curated, hand-maintained facilities.
 *
 * These 24 records are the original directory inventory: rich descriptions,
 * photo sets, and partner flags maintained by editors. License-field data
 * for these records lives in src/data/imported.generated.ts (LICENSE_ENRICHMENT)
 * and is merged at load time in src/data/locations.ts — never edit license
 * fields here, they'll be clobbered on the next CDSS import run.
 *
 * To add a curated facility: append a new record below. To enrich one with
 * a CCLD license, add (or update) the row in the CSV and re-run
 *   node scripts/import-cdss.mjs
 */

import type { Facility } from '../types/facility';

export const CURATED_FACILITIES: Facility[] = [
  {
