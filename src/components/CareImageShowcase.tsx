  ...
  return (
    <section className="py-20 bg-gradient-to-br from-senior-blue via-senior-blue to-senior-slate relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 right-20 w-80 h-80 bg-senior-teal/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="container-custom relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <div className="w-32 h-1 bg-gradient-to-r from-senior-teal to-senior-sand rounded-full mx-auto mb-6"></div>
                    ...
                    <CardContent className="p-0">
                      <div className="grid md:grid-cols-2 gap-0 items-center min-h-[500px]">
                        ...
                        <div className="p-8 md:p-12 bg-white h-full flex flex-col justify-center space-y-6">
                          ...
                          <div className="w-16 h-1 bg-gradient-to-r from-senior-blue to-senior-teal rounded-full"></div>
                          <p className="text-lg text-gray-600 leading-relaxed">
                            {image.description}
                          </p>
                          <div className="flex items-center text-senior-blue font-medium hover:text-senior-teal transition-colors cursor-pointer group">
