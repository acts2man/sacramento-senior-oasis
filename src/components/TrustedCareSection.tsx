      ...
      <div className="container-custom relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-in">
            ...
            <p className="text-lg text-neutral-600 leading-relaxed">Sacramento ElderCare Directory helps families find the right assisted living community across the greater Sacramento area. Whether you're looking for assisted living, memory care, or independent living options, we provide comprehensive information to help you make informed decisions about your loved one's care.</p>
